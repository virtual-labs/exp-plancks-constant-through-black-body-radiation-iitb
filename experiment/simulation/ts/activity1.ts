...
function a1_load_questions() {}
{
	...
	question.push({
		srno: 2,
		question:
			"Select <span style='color: #018fc3'> Photo Current Meter </span>",
	...
	question.push({
		srno: 3,
		question:
			"Select <span style='color: #018fc3'>Photo Current Detector </span>",
	...
	question.push({
		srno: 5,
		question:
			"Select <span style='color: #018fc3'>Voltage/Current Meter</span>",
...
function load_higlighted_images() {
	...
	a1_labels = [
		new Chemistry.Text(
			'Light Source',
			new Chemistry.Point(780, 300),
			canvas
		),

		new Chemistry.Text(
			'Photo-Current-Meter',
			new Chemistry.Point(1070, 750),
			canvas
		),

		new Chemistry.Text(
			'Photo-Current-Detector',
