...
function a1_draw_all_components() {
    var sq = new Chemistry.Custome_image(bulb, new Chemistry.Point(1000, 300), 294 * 0.5, 1005 * 0.5, canvas);
    sq.name = 'Light Source';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(photocurrentmeter, new Chemistry.Point(1600, 750), 1142 * 0.45, 822 * 0.45, canvas);
    sq.name = 'Photo-Current-Meter';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(photodectector, new Chemistry.Point(1500, 250), 295 * 0.45, 964 * 0.45, canvas);
    sq.name = 'Photo-Current-Detector';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(stand, new Chemistry.Point(400, 830), 1781 * 0.4, 254 * 0.4, canvas);
    sq.name = 'Stand';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(cv_meter, new Chemistry.Point(300, 260), 1141 * 0.45, 822 * 0.45, canvas);
    sq.name = 'Voltage/Current Meter';
    scene.add(sq);
}
...
function a1_load_questions() { }
{
    ...
    question.push({
        srno: 2,
        question: "Select <span style='color: #018fc3'> Photo Current Meter </span>",
        ans: 'Photo-Current-Meter',
        hint: ['Rectangular', 'Mounted Vertically', 'Has valves attached'],
    });
    question.push({
        srno: 3,
        question: "Select <span style='color: #018fc3'>Photo Current Detector </span>",
        ans: 'Photo-Current-Detector',
        hint: ['Rectangular', 'Mounted Vertically', 'Has valves attached'],
    });
    question.push({
        srno: 4,
        question: "Select <span style='color: #018fc3'>Stand</span>",
        ans: 'Stand',
        hint: [
            'Double Pipe',
            'pipe inside a pipe',
    ...
    question.push({
        srno: 5,
        question: "Select <span style='color: #018fc3'>Voltage/Current Meter</span>",
        ans: 'Voltage/Current Meter',
...
function load_higlighted_images() {
    highlighted_images = [
        [bulb, bulb],
        [photocurrentmeter, photocurrentmeter],
        [photodectector, photodectector],
        [stand, stand],
        [cv_meter, cv_meter],
    ];
    a1_labels = [
        new Chemistry.Text('Light Source', new Chemistry.Point(780, 300), canvas),
        new Chemistry.Text('Photo-Current-Meter', new Chemistry.Point(1070, 750), canvas),
        new Chemistry.Text('Photo-Current-Detector', new Chemistry.Point(1600, 300), canvas),
        new Chemistry.Text('Stand', new Chemistry.Point(300, 750), canvas),
        new Chemistry.Text('Voltage/Current Meter', new Chemistry.Point(230, 480), canvas),
    ];
